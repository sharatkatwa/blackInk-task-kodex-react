...
const BlogCards = ({article}) => {
  ...
  return (
    <div onClick={() =>navigate(`/blog/${article.id}`)} className=" flex flex-col justify-between border border-gray-500/10 bg-gray-500/5 h-70 rounded-lg py-5 px-5 hover:border-primary shadow hover:shadow-xl hover:shadow-primary/20  group ">
      <div className="top">
      ...
      <div className=" text-balance flex items-center justify-between text-sm text-muted">
